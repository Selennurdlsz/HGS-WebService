...
namespace HGS_WebService
{
    ...
    public class HGSService : System.Web.Services.WebService
    {
        ...
        SqlConnection connection = new SqlConnection(@"Data Source=LAPTOP-B269SBH2;Initial Catalog=HgsDB;Integrated Security=True");



        [WebMethod]
        public bool SaleHGS(decimal balance, int customerId, string customerTCKN, string plateNumber, DateTime saleDate)
        {
            try
            {  
                connection.Open();
                string create = "INSERT INTO HGS(Balance,CustomerId,CustomerTCKN,PlateNumber,SaleDate) VALUES (@balance,@customerId,@customerTCKN,@plateNumber,@saleDate)";
        ...
        {
            SqlConnection connection2 = new SqlConnection(@"Data Source=LAPTOP-B269SBH2;Initial Catalog=BankDB;Integrated Security=True");
